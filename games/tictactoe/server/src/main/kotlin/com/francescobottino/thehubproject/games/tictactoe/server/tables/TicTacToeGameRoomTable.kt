...
object TicTacToeGameRoomTable: Table("tic_tac_toe_game_rooms") {
    ...
    val roomStateWinnerSign = enumerationByName("room_state_winner_sign", 1, TicTacToePlayerSign::class).nullable() // For Finished state
    val roomStateClosedBySign = enumerationByName("room_state_closed_by_sign", 1, TicTacToePlayerSign::class).nullable() // For Closed state
